...
const Hornets = () => {
  return (
    <div>
      <TeamNavbar navdesign="navbar navbar-expand-lg navbar-dark  bg-hornetsteamnav">
      <div className="container-fluid align-items-center ">
                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup" >
                    ...
                    <div className="navbar-nav me-auto ms-auto">
                        ...
                        <Link className="nav-link bg-white logo my-2 text-center " to="/hornets"><img src={HornetsLogo} alt="" /></Link>
